...
namespace Hermit.Injection
{
    public class DiContainer : IDependencyContainer
    {
        ...
        protected readonly List<IServiceRegistry> Modules = new List<IServiceRegistry>();
        ...
        public IDependencyContainer MountModule(params IServiceRegistry[] serviceProviders)
        {
