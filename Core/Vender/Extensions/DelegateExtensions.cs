...
namespace Hermit
{
    public static class DelegateExtensions
    {
        ...
        public static Delegate CreateDelegate(this MethodInfo methodInfo, object target)
        {
            ...
            if (isAction) { getType = Expression.GetActionType; } else
            {
        ...
        public static Action<object, object> CreateSetter(this FieldInfo field)
        {
            ...
            var setterMethod = new DynamicMethod(methodName, null, new[] {typeof(object), typeof(object)}, true);
        ...
        public static Func<S, T> CreateGetter<S, T>(this FieldInfo field)
        {
            ...
            var gen = setterMethod.GetILGenerator();
            if (field.IsStatic) { gen.Emit(OpCodes.Ldsfld, field); } else
            {
                gen.Emit(OpCodes.Ldarg_0);
                gen.Emit(OpCodes.Ldfld, field);
            }
