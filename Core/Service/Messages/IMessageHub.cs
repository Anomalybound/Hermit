...
namespace Hermit.Service.Messages
{
    public interface IMessageHub : IDisposable
    {
        ...
        /// </param>
        Guid RegisterGlobalHandler(Action<Type, object> onMessage);
        ...
        void UnregisterGlobalHandler(Guid token);
        ...
        /// </summary>
        Guid RegisterGlobalErrorHandler(Action<Guid, Exception> onError);
        
        /// <summary>
        /// Unsubscribes a global message error handler from the <see cref="IMessageHub"/>.
        /// </summary>
        /// <param name="token">The token representing the handler</param>
        void UnregisterGlobalErrorHandler(Guid token);
